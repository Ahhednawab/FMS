                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Layouts"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.users.index') }}"
                                class="nav-link {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">User
                                Management</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.cities.index') }}"
                                class="nav-link {{ request()->routeIs('admin.cities.*') ? 'active' : '' }}">City
                                Management</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.stations.index') }}"
                                class="nav-link {{ request()->routeIs('admin.stations.*') ? 'active' : '' }}">Station
                                Management</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.ibcCenters.index') }}"
                                class="nav-link {{ request()->routeIs('admin.ibcCenters.*') ? 'active' : '' }}">IBC
                                Center Management</a>
                        </li>
                        {{-- <li class="nav-item">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Layouts"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.vehicles.index') }}"
                                class="nav-link {{ request()->routeIs('admin.vehicles.*') ? 'active' : '' }}">Vehicle
                                Master Data</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.drivers.index') }}"
                                class="nav-link {{ request()->routeIs('admin.drivers.*') ? 'active' : '' }}">Driver
                                Master Data</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.vendors.index') }}"
                                class="nav-link {{ request()->routeIs('admin.vendors.*') ? 'active' : '' }}">Vendor
                                Management</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.insurance-companies.index') }}"
                                class="nav-link {{ request()->routeIs('admin.insurance-companies.*') ? 'active' : '' }}">Insurance
              ...
              : '' }}">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Layouts"
                        ...
                        <li class="nav-item"><a href="{{ route('admin.brands.index') }}"
                                class="nav-link {{ request()->routeIs('admin.brands.*') ? 'active' : '' }}">Brand
                                Management</a></li>
                        <li class="nav-item"><a href="{{ route('admin.categories.index') }}"
                                class="nav-link {{ request()->routeIs('admin.categories.*') ? 'active' : '' }}">Category
                                Management</a></li>
          ...
          request()->routeIs('admin.dailyFuelReports.*')
              ...
              : '' }}">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Layouts"
                        ...
                        <li class="nav-item"><a href="{{ route('admin.dailyMileages.index') }}"
                                class="nav-link {{ request()->routeIs('admin.dailyMileages.*') ? 'active' : '' }}">Daily
                                Mileage</a></li>
                        <li class="nav-item"><a href="{{ route('admin.dailyMileageReports.index') }}"
                                class="nav-link {{ request()->routeIs('admin.dailyMileageReports.*') ? 'active' : '' }}">Mileage
                                Report</a></li>
                        <li class="nav-item"><a href="{{ route('admin.dailyFuels.index') }}"
                                class="nav-link {{ request()->routeIs('admin.dailyFuels.*') ? 'active' : '' }}">Daily
                                Fueling</a></li>
                        <li class="nav-item"><a href="{{ route('admin.dailyFuelReports.index') }}"
                                class="nav-link {{ request()->routeIs('admin.dailyFuelReports.*') ? 'active' : '' }}">Fuel
                                Report</a></li>
                    </ul>
                </li>
    ...
    request()->routeIs('admin.suppliers.*')
        ...
        : '' }}">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Inventory"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.productList.index') }}"
                                class="nav-link {{ request()->routeIs('admin.productList.*') ? 'active' : '' }}">
                                Products List
                            </a>
                        </li>
          ...
          <ul class="nav nav-group-sub" data-submenu-title="Layouts">
            ...
            <li class="nav-item"><a href="{{ route('admin.inventoryLargerReports.index')}}" class="nav-link">Inventory Larger Report</a></li>
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                        <li class="nav-item"><a href="{{ route('admin.accidentDetails.index') }}"
                                class="nav-link">Accident Details</a></li>
                        <li class="nav-item"><a href="{{ route('admin.accidentReports.index') }}"
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                        ...
                        <li class="nav-item"><a href="{{ route('admin.cashPayments.index') }}" class="nav-link">Cash
                                Payment Voucher</a></li>
                        <li class="nav-item"><a href="{{ route('admin.bankPayments.index') }}" class="nav-link">Bank
                                Payment Voucher</a></li>
                    </ul>
                </li>
