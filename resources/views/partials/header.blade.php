 <!-- Main navbar -->
 <div class="navbar navbar-expand-lg navbar-dark navbar-static sticky-top">
 ...
 <img src={{ asset('assets/images/placeholders/placeholder.jpg') }} class="rounded-pill mr-lg-2"
 height="34" alt="">
