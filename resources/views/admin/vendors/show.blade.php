    ...
    <div class="page-header-content header-elements-lg-inline">
      ...
      <div class="header-elements d-none">
        <div class="d-flex justify-content-center">
          <a href="{{ route('admin.vendors.index') }}" class="btn btn-primary"><span>View Vendors <i class="icon-list ml-2"></i></span></a>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="text-right">
              ...
              <form action="{{ route('admin.vendors.destroy', 1) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this Vendor?');">
                @csrf
                @method('DELETE')
