                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $vendor->serial_no }}" name="serial_no" type="text"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone" id="phone" class="form-control"
                                            value="{{ old('phone', $vendor->phone, '03' ?? '') }}" maxlength="12"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="vendor_type_id">
                                            ...
                                            @foreach ($vendor_types as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ old('vendor_type_id', $vendor->vendor_type_id ?? '') == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select class="custom-select" name="city_id">
                                            ...
                                            @foreach ($cities as $key => $value)
                                                <option value="{{ $value->id }}"
                                                    {{ old('city_id', $vendor->city_id ?? '') == $value->id ? 'selected' : '' }}>
                                                    {{ $value->name }}</option>
                                            @endforeach
                                        </select>
