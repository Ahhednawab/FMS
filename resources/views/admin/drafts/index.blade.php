                  ...
                  <div class="list-icons">
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <a href="{{ route('admin.drafts.edit', $draft) }}" class="dropdown-item">
                          <i class="icon-eye"></i> Edit Draft
                        </a>
                        <form action="{{ route('admin.drafts.destroy', $draft) }}" method="POST">
                          @csrf
                          @method('DELETE')
                          <button class="dropdown-item text-danger" onclick="return confirm('Are you sure you want to delete this draft?')">
