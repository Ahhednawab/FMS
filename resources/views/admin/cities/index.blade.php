                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="{{ route('cities.show', $value->id) }}" class="dropdown-item"><i
                                                        class="icon-eye"></i> View</a>
                                                <a href="{{ route('cities.edit', $value->id) }}" class="dropdown-item"><i
                                                        class="icon-pencil7"></i> Edit</a>
                                                <form method="POST" action="{{ route('cities.destroy', $value->id) }}"
