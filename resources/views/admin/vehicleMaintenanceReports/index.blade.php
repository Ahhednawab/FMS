        ...
        <div class="page-header-content header-elements-lg-inline">
            ...
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <a href="{{ route('vehicleMaintenanceReports.create') }}" class="btn btn-primary">
                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="{{ route('vehicleMaintenanceReports.show', $value->id) }}"
                                                    class="dropdown-item">
                                                    <i class="icon-eye"></i> View Details
                                                </a>
                                                <a href="{{ route('vehicleMaintenanceReports.edit', $value->id) }}"
                                                    class="dropdown-item">
                                                    <i class="icon-pencil7"></i> Edit
                                                </a>
                                                <form action="{{ route('vehicleMaintenanceReports.destroy', $value->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
