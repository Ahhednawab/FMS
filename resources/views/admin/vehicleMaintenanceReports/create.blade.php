...
@section('title', 'Add Vehicle Maintenance Report')
...
@section('content')
  ...
  <div class="page-header page-header-light">
    <div class="page-header-content header-elements-lg-inline">
      <div class="page-title d-flex">
          <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Vehicle Maintenance Report Management</span></h4>
      </div>
  ...
  <div class="content">
    <div class="card">
      <div class="card-body">
        <form action="{{ route('admin.vehicleMaintenanceReports.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input value="{{$maintenance_report_id}}" name="maintenance_report_id" type="text" class="form-control" readonly>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="number" min="1" step="1" class="form-control" name="odo_meter_reading" value="{{ old('odo_meter_reading') }}">
          ...
          <div class="row">
              ...
              <div class="form-group">
                ...
                <select class="custom-select" name="fuel_type">
                  ...
                  @foreach($fuel_types as $key => $value)
                    <option value="{{$key}}" {{ old('fuel_type') == $key ? 'selected' : '' }}>{{$value}}</option>
                  @endforeach
                </select>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="date" class="form-control" name="service_date" value="{{ old('service_date') }}">
              ...
              <div class="form-group">
                ...
                <select class="custom-select" name="service_provider">
                  ...
                  @foreach($service_provider as $key => $value)
                    <option value="{{$key}}" {{ old('service_provider') == $key ? 'selected' : '' }}>{{$value}}</option>
                  @endforeach
                </select>
          ...
          <div class="row">
              ...
              <div class="form-group">
                ...
                <select class="custom-select" name="parts_replaced">
                    ...
                    @foreach($parts as $key => $value)
                      <option value="{{$key}}" {{ old('parts_replaced') == $key ? 'selected' : '' }}>{{$value}}</option>
                    @endforeach
                  </select>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="number" min="1" step="1" class="form-control" name="service_cost" value="{{ old('service_cost') }}">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <textarea class="form-control" name="service_description" value="{{ old('service_description') }}"></textarea>
              ...
              <div class="form-group">
                ...
                <select class="custom-select" name="tyre_condition">
                    ...
                    @foreach($tyre_conditions as $key => $value)
                      <option value="{{$key}}" {{ old('tyre_condition') == $key ? 'selected' : '' }}>{{$value}}</option>
                    @endforeach
                  </select>
          ...
          <div class="row">
              ...
              <div class="form-group">
                ...
                <select class="custom-select" name="brake_condition">
                    ...
                    @foreach($brake_conditions as $key => $value)
                      <option value="{{$key}}" {{ old('brake_condition') == $key ? 'selected' : '' }}>{{$value}}</option>
                    @endforeach
                  </select>
              ...
              <div class="form-group">
                ...
                <select class="custom-select" name="engine_condition">
                  ...
                  @foreach($engine_conditions as $key => $value)
                    <option value="{{$key}}" {{ old('engine_condition') == $key ? 'selected' : '' }}>{{$value}}</option>
                  @endforeach
                </select>
              ...
              <div class="form-group">
                ...
                <select class="custom-select" name="battery_condition">
                  ...
                  @foreach($battery_conditions as $key => $value)
                    <option value="{{$key}}" {{ old('battery_condition') == $key ? 'selected' : '' }}>{{$value}}</option>
                  @endforeach
                </select>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="date" class="form-control" name="next_service_date" value="{{ old('next_service_date') }}">
