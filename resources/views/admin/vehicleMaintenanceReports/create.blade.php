...
@section('content')
    ...
    <div class="content">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('vehicleMaintenanceReports.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input value="{{ $maintenance_report_id }}" name="maintenance_report_id" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select select2" id="vehicle_id" name="vehicle_id">
                                    ...
                                    @foreach ($vehicles as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('vehicle_id') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="1" step="1" class="form-control"
                                    name="odo_meter_reading" value="{{ old('odo_meter_reading') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="category">
                                    ...
                                    @foreach ($category as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('category') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="service_provider">
                                    ...
                                    @foreach ($service_provider as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('service_provider') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="parts_replaced">
                                    ...
                                    @foreach ($parts as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('parts_replaced') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="1" step="1" class="form-control" name="service_cost"
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="tyre_condition">
                                    ...
                                    @foreach ($tyre_conditions as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('tyre_condition') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="brake_condition">
                                    ...
                                    @foreach ($brake_conditions as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('brake_condition') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="engine_condition">
                                    ...
                                    @foreach ($engine_conditions as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('engine_condition') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="battery_condition">
                                    ...
                                    @foreach ($battery_conditions as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('battery_condition') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="text-right">
                                ...
                                <a href="{{ route('vehicleMaintenanceReports.index') }}"
