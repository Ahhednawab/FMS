  ...
  <div class="page-header page-header-light">
    <div class="page-header-content header-elements-lg-inline">
      <div class="page-title d-flex">
        <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Vehicle Maintenance Report Detail</span></h4>
        <a href="#" class="header-elements-toggle text-body d-lg-none"><i class="icon-more"></i></a>
      </div>
      <div class="header-elements d-none">
        <div class="d-flex justify-content-center">
          <a href="{{ route('admin.vehicleMaintenanceReports.index') }}" class="btn btn-primary"><span>View Vehicle Maintenance Report <i class="icon-list ml-2"></i></span></a>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="container mt-3">
          ...
          <div class="row">
            ...
            <div class="col-md-3 text-center">
              <div class="card">
                ...
                <p>{{ \Carbon\Carbon::parse($vehicleMaintenanceReport->next_service_date)->format('d-M-Y') }}</p>
              </div>
            </div>
          </div>
          <!-- /basic datatable -->
          <div class="col-md-12">
            ...
            <div class="text-right">
              <a href="{{ route('admin.vehicleMaintenanceReports.edit', $vehicleMaintenanceReport->id) }}" class="btn btn-warning">Edit</a>
                <a href="{{ route('admin.vehicleMaintenanceReports.index') }}" class="btn btn-secondary">Back</a>
                <form action="{{ route('admin.vehicleMaintenanceReports.destroy', $vehicleMaintenanceReport->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this Vehicle Maintenance Report?');">
                  @csrf
                  @method('DELETE')
