              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="serial_no" class="form-control" value="{{$warehouse->serial_no}}" readonly>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <select name="station_id" id="station_id" class="form-control">
                      ...
                      @foreach($stations as $key => $value)
                        <option value="{{ $key }}" {{ old('station_id', $warehouse->station_id ?? '') == $key ? 'selected' : '' }}>
                          {{ $value }}
                        </option>
                      @endforeach
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <select name="manager_id" id="manager_id" class="form-control">
                      ...
                      @foreach($managers as $key => $value)
                        <option value="{{ $key }}" {{ old('manager_id', $warehouse->manager_id ?? '') == $key ? 'selected' : '' }}>
                          {{ $value }}
                        </option>
                      @endforeach
                    </select>
