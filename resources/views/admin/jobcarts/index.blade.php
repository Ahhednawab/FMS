        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="mb-3 d-flex align-items-end">
                    ...
                    <a href="{{ route('master-warehouse.jobcarts.create') }}" class="btn btn-primary">Create New Job
                        Cart</a>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            <thead class="table-dark">
                                <tr>
                                    <th class="text-capitalize">Serial No.</th>
                                    <th class="text-capitalize">Vehicle</th>
                                    <th class="text-capitalize">Issue</th>
                                    ...
                                    <th class="text-capitalize">Requested At</th>
                            ...
                            <tbody>
                                @foreach ($jobCarts as $job)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('master-warehouse.jobcarts.show', $job->id) }}"
