                  ...
                  <div class="form-group">
                    ...
                    <div class="d-flex align-items-center mt-2">
                      <div class="form-check mr-3">
                        <input class="form-check-input" type="radio" name="pool_vehicle" id="pool_yes" value="1" {{ old('pool_vehicle', $vehicle->pool_vehicle ?? '') == '1' ? 'checked' : '' }}>
                        <label class="form-check-label" for="pool_yes">Yes</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="pool_vehicle" id="pool_no" value="0" {{ old('pool_vehicle', $vehicle->pool_vehicle ?? '') == '0' ? 'checked' : '' }}>
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <div class="d-flex align-items-center mt-2">
                      <div class="form-check mr-3">
                        <input class="form-check-input" type="radio" name="on_duty_status" id="on_duty_status_yes" value="1" {{ old('on_duty_status', $vehicle->on_duty_status ?? '') == '1' ? 'checked' : '' }}>
                        <label class="form-check-label" for="on_duty_status_yes">Yes</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="on_duty_status" id="on_duty_status_no" value="0" {{ old('on_duty_status', $vehicle->on_duty_status ?? '') == '0' ? 'checked' : '' }}>
