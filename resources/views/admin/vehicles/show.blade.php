        ...
        <div class="page-header-content header-elements-lg-inline">
            ...
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <a href="{{ route('vehicles.index') }}" class="btn btn-primary"><span>View Vehicles <i
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 text-center">
                            <div class="card">
                                ...
                                <p>{{ $vehicle->induction_date && $vehicle->induction_date !== '0000-00-00' ? \Carbon\Carbon::parse($vehicle->induction_date)->format('d-M-Y') : 'N/A' }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 text-center">
                            <div class="card">
                                ...
                                <p><a href="{{ asset('uploads/vehicles/' . $vehicle->fitness_file) }}" download>
                                        Download</a></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 text-center">
                            <div class="card">
                                ...
                                <p><a href="{{ asset('uploads/vehicles/' . $vehicle->registration_file) }}" download>
                                        Download</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 text-center">
                            <div class="card">
                                ...
                                <p><a href="{{ asset('uploads/vehicles/' . $vehicle->insurance_file) }}" download>
                                        Download</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 text-center">
                            <div class="card">
                                ...
                                <p><a href="{{ asset('uploads/vehicles/' . $vehicle->route_permit_file) }}" download>
                                        Download</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 text-center">
                            <div class="card">
                                ...
                                <p><a href="{{ asset('uploads/vehicles/' . $vehicle->tax_file) }}" download> Download</a>
                                </p>
                            </div>
                        </div>
                    </div>
