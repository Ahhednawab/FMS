...
@section('content')
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input value="{{ $serial_no }}" name="serial_no" type="text" class="form-control"
                                    readonly>
                            </div>
                        </div>
                ...
                @error('vehicle_no') is-invalid @enderror"
                                    name="vehicle_no" value="{{ $draftData['vehicle_no'] ?? old('vehicle_no') }}">
                ...
                @error('chasis_no') is-invalid @enderror"
                                    name="chasis_no" value="{{ $draftData['chasis_no'] ?? old('chasis_no') }}">
                ...
                @error('engine_no') is-invalid @enderror"
                                    name="engine_no" value="{{ $draftData['engine_no'] ?? old('engine_no') }}">
               ...
               @error('ownership') is-invalid @enderror"
                                ...
                                <div class="d-flex align-items-center mt-2">
                                    ...
                                    <div class="form-check mr-3">
                                        <input class="form-check-input {{ $draftMissing ? 'border-danger' : '' }}"
                                            type="radio" name="pool_vehicle" id="pool_yes" value="1"
                                            {{ ($draftData['pool_vehicle'] ?? old('pool_vehicle')) == '1' ? 'checked' : '' }}>
                                        <label class="form-check-label {{ $draftMissing ? 'text-danger' : '' }}"
                                            for="pool_yes">Yes</label>
                                    </div>

                                    <div class="form-check">
                                        <input class="form-check-input {{ $draftMissing ? 'border-danger' : '' }}"
                                            type="radio" name="pool_vehicle" id="pool_no" value="0"
                        ...
                        <div class="col-md-3 d-none">
                            <div class="form-group">
                                <strong>Cone</strong>
                                <input type="number" min="0" step="1" class="form-control" name="cone"
                                    value="{{ $draftData['cone'] ?? old('cone') }}">
                                @if ($errors->has('cone'))
            ...
            {{ $isDraftMode && empty($draftData['pso_card'] ?? '') ? 'is-invalid' : '' }}"
                                    name="pso_card" value="{{ $draftData['pso_card'] ?? old('pso_card') }}">
                ...
                @error('ibc_center_id') is-invalid @enderror">
                                    ...
                                    @foreach ($stations as $station)
                                        @foreach ($station->ibcCenter ?? [] as $center)
                                            <option value="{{ $center->id }}" data-station="{{ $station->id }}"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center mt-2">
                                    ...
                                    <div class="form-check mr-3">
                                        <input class="form-check-input {{ $draftMissing ? 'border-danger' : '' }}"
                                            type="radio" name="on_duty_status" id="on_duty_status_yes" value="1"
                                            {{ ($draftData['on_duty_status'] ?? old('on_duty_status')) == '1' ? 'checked' : '' }}>
                                        <label class="form-check-label {{ $draftMissing ? 'text-danger' : '' }}"
                                            for="on_duty_status_yes">Yes</label>
                                    </div>

                                    <div class="form-check">
                                        <input class="form-check-input {{ $draftMissing ? 'border-danger' : '' }}"
                                            type="radio" name="on_duty_status" id="on_duty_status_no" value="0"
                                            {{ ($draftData['on_duty_status'] ?? old('on_duty_status')) == '0' ? 'checked' : '' }}>
                                        <label class="form-check-label {{ $draftMissing ? 'text-danger' : '' }}"
                                            for="on_duty_status_no">No</label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                @if (isset($draftData['file_info']['fitness_file']))
                                    <div class="mt-2 d-flex align-items-center">
                                        <a href="{{ route('drafts.view', base64_encode($draftData['file_info']['fitness_file']['path'])) }}"
                                            target="_blank" class="text-success mr-2" title="View">
                                            <i class="icon-file"></i>
                                            {{ $draftData['file_info']['fitness_file']['original_name'] }}
                                        </a>
                                        <span
                                            class="text-muted mr-2">({{ number_format(($draftData['file_info']['fitness_file']['size'] ?? 0) / 1024, 1) }}
                                            KB)</span>
                                        <button type="button" class="btn btn-sm btn-outline-danger" title="Remove"
                                            onclick="removeDraftFile('fitness_file', this)">×</button>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                @if (isset($draftData['file_info']['registration_file']))
                                    <div class="mt-2 d-flex align-items-center">
                                        <a href="{{ route('drafts.view', base64_encode($draftData['file_info']['registration_file']['path'])) }}"
                                            target="_blank" class="text-success mr-2" title="View">
                                            <i class="icon-file"></i>
                                            {{ $draftData['file_info']['registration_file']['original_name'] }}
                                        </a>
                                        <span
                                            class="text-muted mr-2">({{ number_format(($draftData['file_info']['registration_file']['size'] ?? 0) / 1024, 1) }}
                                            KB)</span>
                                        <button type="button" class="btn btn-sm btn-outline-danger" title="Remove"
                                            onclick="removeDraftFile('registration_file', this)">×</button>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                @if (isset($draftData['file_info']['insurance_file']))
                                    <div class="mt-2 d-flex align-items-center">
                                        <a href="{{ route('drafts.view', base64_encode($draftData['file_info']['insurance_file']['path'])) }}"
                                            target="_blank" class="text-success mr-2" title="View">
                                            <i class="icon-file"></i>
                                            {{ $draftData['file_info']['insurance_file']['original_name'] }}
                                        </a>
                                        <span
                                            class="text-muted mr-2">({{ number_format(($draftData['file_info']['insurance_file']['size'] ?? 0) / 1024, 1) }}
                                            KB)</span>
                                        <button type="button" class="btn btn-sm btn-outline-danger" title="Remove"
                                            onclick="removeDraftFile('insurance_file', this)">×</button>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                @if (isset($draftData['file_info']['route_permit_file']))
                                    <div class="mt-2 d-flex align-items-center">
                                        <a href="{{ route('drafts.view', base64_encode($draftData['file_info']['route_permit_file']['path'])) }}"
                                            target="_blank" class="text-success mr-2" title="View">
                                            <i class="icon-file"></i>
                                            {{ $draftData['file_info']['route_permit_file']['original_name'] }}
                                        </a>
                                        <span
                                            class="text-muted mr-2">({{ number_format(($draftData['file_info']['route_permit_file']['size'] ?? 0) / 1024, 1) }}
                                            KB)</span>
                                        <button type="button" class="btn btn-sm btn-outline-danger" title="Remove"
                                            onclick="removeDraftFile('route_permit_file', this)">×</button>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                @if (isset($draftData['file_info']['tax_file']))
                                    <div class="mt-2 d-flex align-items-center">
                                        <a href="{{ route('drafts.view', base64_encode($draftData['file_info']['tax_file']['path'])) }}"
                                            target="_blank" class="text-success mr-2" title="View">
                                            <i class="icon-file"></i>
                                            {{ $draftData['file_info']['tax_file']['original_name'] }}
                                        </a>
                                        <span
                                            class="text-muted mr-2">({{ number_format(($draftData['file_info']['tax_file']['size'] ?? 0) / 1024, 1) }}
                                            KB)</span>
                                        <button type="button" class="btn btn-sm btn-outline-danger" title="Remove"
                                            onclick="removeDraftFile('tax_file', this)">×</button>
                                    </div>
                                @endif
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // NOTE: the calculate*() helpers only run when the user changes a
            // base date (see the change listeners above). Running them on load
            // would overwrite expiry dates restored from a saved draft or from
