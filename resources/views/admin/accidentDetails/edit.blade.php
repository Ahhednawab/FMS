  ...
  <div class="content">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <form method="POST" action="{{ route('admin.accidentDetails.update', $accidentDetail->id) }}" enctype="multipart/form-data">
              @csrf
              @method('PUT')
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input value="{{$accidentDetail->accident_id}}" name="accident_id" type="text" class="form-control" readonly>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="accident_type">
                      ...
                      @foreach($accident_types as $key => $value)
                        <option value="{{$key}}" {{ old('accident_type', $accidentDetail->accident_type ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="location" value="{{ old('location', $accidentDetail->location ?? '') }}">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="accident_date" value="{{ old('accident_date', $accidentDetail->accident_date ?? '') }}">
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    <div class="form-group">
                      ...
                      <input type="time" class="form-control" name="accident_time" value="{{ old('accident_time', $accidentDetail->accident_time ?? '') }}">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="accident_description" value="{{ old('accident_description', $accidentDetail->accident_description ?? '') }}">
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="person_involved">
                      ...
                      @foreach($users as $key => $value)
                        <option value="{{$key}}" {{ old('person_involved', $accidentDetail->person_involved ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="injury_type">
                      ...
                      @foreach($injury_types as $key => $value)
                        <option value="{{$key}}" {{ old('injury_type', $accidentDetail->injury_type ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="damage_type">
                      ...
                      @foreach($damage_types as $key => $value)
                        <option value="{{$key}}" {{ old('damage_type', $accidentDetail->damage_type ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
