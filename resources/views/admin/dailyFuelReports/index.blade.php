...
@section('content')
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Daily Fuel Report List</span>
                </h4>
                            ...
                            <div class="dropdown-menu dropdown-menu-right" id="column-visibility">
                                ...
                                <div class="px-3">
                                    ...
                                    <div class="custom-control custom-checkbox mb-2">
                                        ...
                                        <label class="custom-control-label" for="col3">From</label>
                                    </div>
                                    <div class="custom-control custom-checkbox mb-2">
                                        <input type="checkbox" class="custom-control-input column-toggle" id="col4"
                                            data-column="3" checked>
                                        <label class="custom-control-label" for="col4">To</label>
                                    </div>
                                    <div class="custom-control custom-checkbox mb-2">
                                    ...
                                    <div class="custom-control custom-checkbox mb-2">
                                        <input type="checkbox" class="custom-control-input column-toggle" id="col8"
                                            data-column="7" checked>
                                        <label class="custom-control-label" for="col8">Fuel Taken</label>
                                    </div>
                                    <div class="custom-control custom-checkbox mb-2">
                                        <input type="checkbox" class="custom-control-input column-toggle" id="col9"
                                            data-column="8" checked>
                                        <label class="custom-control-label" for="col9">Fuel Avg</label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input column-toggle" id="col10"
                                            data-column="9" checked>
                                        <label class="custom-control-label" for="col10">AKPL</label>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        window.JSZip = JSZip; // ✅ JSZip load hone ke baad
    </script>
