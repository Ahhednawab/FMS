...
@section('title', 'Add Inventory Demand')

@section('content')
  <div class="page-header page-header-light">
    <div class="page-header-content header-elements-lg-inline">
      <div class="page-title d-flex">
          <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Inventory Demand Management</span></h4>
      </div>
  ...
  <div class="content">
    <div class="card">
      <div class="card-body">
        <form action="{{ route('admin.inventoryDemands.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
              ...
              <div class="form-group">
                ...
                <select class="custom-select" name="requested_by">
                  ...
                  @foreach($users as $key => $value)
                    <option value="{{$key}}" {{ old('requested_by') == $key ? 'selected' : '' }}>{{$value}}</option>
                  @endforeach
                </select>
          ...
          <div class="row">
            ...
            {{-- <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="number" min="1" step="1" class="form-control" name="product_price" value="{{ old('product_price') }}">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="number" min="1" step="1" class="form-control" name="requested_qty" value="{{ old('requested_qty') }}">
