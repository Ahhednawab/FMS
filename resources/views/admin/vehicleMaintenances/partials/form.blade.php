...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input list="work_done_options" name="work_done" id="work_done" class="form-control"
                value="{{ old('work_done', $maintenance?->workDone?->name) }}" required>
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" name="labor_cost" id="labor_cost" min="0" step="0.01" class="form-control"
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>Amount</label>
            <input type="number" id="amount" class="form-control" value="{{ old('service_cost', $maintenance?->service_cost ?? 0) }}" readonly>
        </div>
    </div>
</div>
...
<div class="table-responsive mt-3">
    ...
    <button type="button" class="btn btn-light" id="add-part-row">Add Part</button>
</div>
