    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Edit Vehicle Maintenance</span>
                </h4>
    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('vehicleMaintenances.update', $vehicleMaintenance->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $vehicleMaintenance->maintenance_id }}" name="maintenance_id"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select select2" id="vehicle_id" name="vehicle_id">
                                            ...
                                            @foreach ($vehicles as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ old('vehicle_id', $vehicleMaintenance->vehicle_id ?? '') == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="model"
                                            value="{{ old('model', $vehicleMaintenance->model ?? '') }}">
                                        @if ($errors->has('model'))
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" step="1" class="form-control"
                                            ...
                                            value="{{ old('odometer_reading', $vehicleMaintenance->odometer_reading ?? '') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="fuel_type">
                                            ...
                                            @foreach ($fuel_types as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ old('fuel_type', $vehicleMaintenance->fuel_type ?? '') == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="category">
                                            ...
                                            @foreach ($category as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ old('category', $vehicleMaintenance->category ?? '') == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="service_date"
                                            value="{{ old('service_date', $vehicleMaintenance->service_date ?? '') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="service_provider">
                                            ...
                                            @foreach ($service_provider as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ old('service_provider', $vehicleMaintenance->service_provider ?? '') == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" name="parts_replaced">
                                                ...
                                                @foreach ($parts as $key => $value)
                                                    <option value="{{ $key }}"
                                                        {{ old('parts_replaced', $vehicleMaintenance->parts_replaced ?? '') == $key ? 'selected' : '' }}>
                                                        {{ $value }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" step="1" class="form-control"
                                            name="service_cost"
                                            value="{{ old('service_cost', $vehicleMaintenance->service_cost ?? '') }}">
