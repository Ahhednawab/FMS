        ...
        <div class="page-header-content header-elements-lg-inline">
            ...
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <a href="{{ route('ibcCenters.index') }}" class="btn btn-primary"><span>View IBC Centers <i
                ...
                <div class="container mt-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="text-right">
                            <a href="{{ route('ibcCenters.edit', $ibcCenter->id) }}" class="btn btn-warning">Edit</a>
                            <a href="{{ route('ibcCenters.index') }}" class="btn btn-secondary">Back</a>
                            <form action="{{ route('ibcCenters.destroy', $ibcCenter->id) }}" method="POST"
