  ...
  <div class="content">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <form method="POST" action="{{ route('admin.ibcCenters.update', $ibcCenter->id) }}">
              @csrf
              @method('PUT')
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="serial_no" class="form-control" value="{{$ibcCenter->serial_no}}" readonly>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="station_id">
                      ...
                      @foreach($stations as $key => $value)
                        <option value="{{$key}}" {{ old('station_id', $ibcCenter->station_id ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" value="{{ old('name', $ibcCenter->name ?? '') }}">
                    @if ($errors->has('name'))
