...
@section('title', 'Add Inventory Dispatch')

@section('content')
  <div class="page-header page-header-light">
    <div class="page-header-content header-elements-lg-inline">
      <div class="page-title d-flex">
          <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Inventory Dispatch Management</span></h4>
      </div>
  ...
  <div class="content">
    <div class="card">
      <div class="card-body">
        <form action="{{ route('admin.inventoryDispatchs.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="date" class="form-control" name="dispatch_date" value="{{ old('dispatch_date') }}">
              ...
              <div class="form-group">
                ...
                <select class="custom-select" name="dispatched_by">
                  ...
                  @foreach($users as $key => $value)
                    <option value="{{$key}}" {{ old('dispatched_by') == $key ? 'selected' : '' }}>{{$value}}</option>
                  @endforeach
                </select>
              ...
              <div class="form-group">
                ...
                <select class="custom-select" name="dispatch_type">
                  ...
                  @foreach($dispatchTypes as $key => $value)
                    <option value="{{$key}}" {{ old('dispatch_type') == $key ? 'selected' : '' }}>{{$value}}</option>
                  @endforeach
                </select>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="number" min="1" step="1" class="form-control" name="order_price" value="{{ old('order_price') }}">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="number" min="1" step="1" class="form-control" name="dispatched_qty" value="{{ old('dispatched_qty') }}">
