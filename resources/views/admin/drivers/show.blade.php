        ...
        <div class="page-header-content header-elements-lg-inline">
            ...
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <a href="{{ route('drivers.index') }}" class="btn btn-primary"><span>View Drivers <i
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 text-center">
                            <div class="card p-2">
                                ...
                                <p><a href="{{ asset('uploads/drivers/' . $driver->cnic_file) }}" download> Download</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 text-center">
                            <div class="card p-2">
                                ...
                                <p>{{ $driver->eobi_start_date ? \Carbon\Carbon::parse($driver->eobi_start_date)->format('d-M-Y') : 'N/A' }}
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="card p-2">
                                ...
                                <p>
                                    @if ($driver->eobi_card_file)
                                        <a href="{{ asset('uploads/drivers/' . $driver->eobi_card_file) }}" download>
                                            Download</a>
                                    @else
                                        N/A
                                    @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 text-center">
                            <div class="card p-2">
                                ...
                                <p><a href="{{ asset('uploads/drivers/' . $driver->picture_file) }}" download> Download</a>
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="card p-2">
                                ...
                                <p>
                                    @if ($driver->medical_report_file)
                                        <a href="{{ asset('uploads/drivers/' . $driver->medical_report_file) }}" download>
                                            Download</a>
                                    @else
                                        N/A
                                    @endif
                        ...
                        <div class="col-md-3 text-center">
                            <div class="card p-2">
                                ...
                                <p><a href="{{ asset('uploads/drivers/' . $driver->authority_letter_file) }}" download>
                                        Download</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 text-center">
                            <div class="card p-2">
                                ...
                                <p><a href="{{ asset('uploads/drivers/' . $driver->employee_card_file) }}" download>
                                        Download</a></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 text-center">
                            <div class="card p-2">
                                <h5 class="m-0">DDC</h5>
                                <p><a href="{{ asset('uploads/drivers/' . $driver->ddc_file) }}" download> Download</a>
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="card p-2">
                                ...
                                <p>
                                    @if (isset($driver->third_party_driver_file))
                                        <a href="{{ asset('uploads/drivers/' . $driver->third_party_driver_file) }}"
                                            download> Download</a>
                                    @else
                                        N/A
                                    @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 text-center">
                            <div class="card p-2">
                                ...
                                <p><a href="{{ asset('uploads/drivers/' . $driver->license_file) }}" download>
                                        Download</a></p>
                            </div>
                        </div>
                    </div>
