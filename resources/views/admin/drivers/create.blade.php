                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="serial_no" class="form-control" value="{{ $serial_no }}"
                                    readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="full_name" class="form-control"
                                    value="{{ $draftData['full_name'] ?? old('full_name') }}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="father_name" class="form-control"
                                    value="{{ $draftData['father_name'] ?? old('father_name') }}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="mother_name" class="form-control"
                                    value="{{ $draftData['mother_name'] ?? old('mother_name') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" id="phone" class="form-control"
                                    value="{{ $draftData['phone'] ?? old('phone') }}">
                                @if ($errors->has('phone'))
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="1" name="salary" class="form-control"
                                    value="{{ $draftData['salary'] ?? old('salary') }}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="account_no" class="form-control"
                                    value="{{ $draftData['account_no'] ?? old('account_no') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="driver_status_id">
                                    ...
                                    @foreach ($driver_status as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ ($draftData['driver_status_id'] ?? old('driver_status_id')) == $key ? 'selected' : '' }}>
                                            {{ $value }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="marital_status_id">
                                    ...
                                    @foreach ($marital_status as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ ($draftData['marital_status_id'] ?? old('marital_status_id')) == $key ? 'selected' : '' }}>
                                            {{ $value }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select select2 vehicle" id="vehicle_id" name="vehicle_id">
                                    ...
                                    @foreach ($vehicles as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ ($draftData['vehicle_id'] ?? old('vehicle_id')) == $key ? 'selected' : '' }}>
                                            {{ $value }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control " id="shift_timing_id" name="shift_timing_id">
                                    ...
                                    @foreach ($shift_timings as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ ($draftData['shift_timing_id'] ?? old('shift_timing_id')) == $key ? 'selected' : '' }}>
                                            {{ $value }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="cnic_no" class="form-control" id="cnic_no"
                                    value="{{ $draftData['cnic_no'] ?? old('cnic_no') }}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" name="cnic_expiry_date" class="form-control"
                                    value="{{ $draftData['cnic_expiry_date'] ?? old('cnic_expiry_date') }}">
                            ...
                            <div class="form-group">
                                ...
                                @if (isset($draftData['file_info']['cnic_file']))
                                    <div class="mt-2 d-flex align-items-center">
                                        ...
                                        <span
                                            class="text-muted mr-2">({{ number_format(($draftData['file_info']['cnic_file']['size'] ?? 0) / 1024, 1) }}
                                            KB)</span>
                                        <button type="button" class="btn btn-sm btn-outline-danger" title="Remove"
                                            onclick="removeDraftFile('cnic_file', this)">×</button>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="eobi_no" class="form-control"
                                    value="{{ $draftData['eobi_no'] ?? old('eobi_no') }}">
                            ...
                            <div class="form-group">
                                ...
                                @if (isset($draftData['file_info']['eobi_card_file']))
                                    <div class="mt-2 d-flex align-items-center">
                                        ...
                                        <span
                                            class="text-muted mr-2">({{ number_format(($draftData['file_info']['eobi_card_file']['size'] ?? 0) / 1024, 1) }}
                                            KB)</span>
                                        <button type="button" class="btn btn-sm btn-outline-danger" title="Remove"
                                            onclick="removeDraftFile('eobi_card_file', this)">×</button>
                                    </div>
                                @endif
                            ...
                            <div class="form-group">
                                ...
                                @if (isset($draftData['file_info']['picture_file']))
                                    <div class="mt-2 d-flex align-items-center">
                                        ...
                                        <span
                                            class="text-muted mr-2">({{ number_format(($draftData['file_info']['picture_file']['size'] ?? 0) / 1024, 1) }}
                                            KB)</span>
                                        <button type="button" class="btn btn-sm btn-outline-danger" title="Remove"
                                            onclick="removeDraftFile('picture_file', this)">×</button>
                                    </div>
                                @endif
                                @if (isset($draftData['file_info']['medical_report_file']))
                                    <div class="mt-2 d-flex align-items-center">
                                        ...
                                        <span
                                            class="text-muted mr-2">({{ number_format(($draftData['file_info']['medical_report_file']['size'] ?? 0) / 1024, 1) }}
                                            KB)</span>
                                        <button type="button" class="btn btn-sm btn-outline-danger" title="Remove"
                                            onclick="removeDraftFile('medical_report_file', this)">×</button>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="Authority letter-group">
                                ...
                                @if (isset($draftData['file_info']['authority_letter_file']))
                                    <div class="mt-2 d-flex align-items-center">
                                        ...
                                        <span
                                            class="text-muted mr-2">({{ number_format(($draftData['file_info']['authority_letter_file']['size'] ?? 0) / 1024, 1) }}
                                            KB)</span>
                                        <button type="button" class="btn btn-sm btn-outline-danger" title="Remove"
                                            onclick="removeDraftFile('authority_letter_file', this)">×</button>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                @if (isset($draftData['file_info']['employee_card_file']))
                                    <div class="mt-2 d-flex align-items-center">
                                        ...
                                        <span
                                            class="text-muted mr-2">({{ number_format(($draftData['file_info']['employee_card_file']['size'] ?? 0) / 1024, 1) }}
                                            KB)</span>
                                        <button type="button" class="btn btn-sm btn-outline-danger" title="Remove"
                                            onclick="removeDraftFile('employee_card_file', this)">×</button>
                                    </div>
                                @endif
                                @if (isset($draftData['file_info']['ddc_file']))
                                    <div class="mt-2 d-flex align-items-center">
                                        ...
                                        <span
                                            class="text-muted mr-2">({{ number_format(($draftData['file_info']['ddc_file']['size'] ?? 0) / 1024, 1) }}
                                            KB)</span>
                                        <button type="button" class="btn btn-sm btn-outline-danger" title="Remove"
                                            onclick="removeDraftFile('ddc_file', this)">×</button>
                                    </div>
                                @endif
                                @if (isset($draftData['file_info']['third_party_driver_file']))
                                    <div class="mt-2 d-flex align-items-center">
                                        ...
                                        <span
                                            class="text-muted mr-2">({{ number_format(($draftData['file_info']['third_party_driver_file']['size'] ?? 0) / 1024, 1) }}
                                            KB)</span>
                                        <button type="button" class="btn btn-sm btn-outline-danger" title="Remove"
                                            onclick="removeDraftFile('third_party_driver_file', this)">×</button>
                                    </div>
                                @endif
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="license_no" class="form-control"
                                    value="{{ $draftData['license_no'] ?? old('license_no') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="license_category_id">
                                    ...
                                    @foreach ($licence_category as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ ($draftData['license_category_id'] ?? old('license_category_id')) == $key ? 'selected' : '' }}>
                                            {{ $value }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" name="license_expiry_date" class="form-control"
                                    value="{{ $draftData['license_expiry_date'] ?? old('license_expiry_date') }}">
                            ...
                            <div class="form-group">
                                ...
                                @if (isset($draftData['file_info']['license_file']))
                                    <div class="mt-2 d-flex align-items-center">
                                        ...
                                        <span
                                            class="text-muted mr-2">({{ number_format(($draftData['file_info']['license_file']['size'] ?? 0) / 1024, 1) }}
                                            KB)</span>
                                        <button type="button" class="btn btn-sm btn-outline-danger" title="Remove"
                                            onclick="removeDraftFile('license_file', this)">×</button>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" name="uniform_issue_date" class="form-control"
                                    value="{{ $draftData['uniform_issue_date'] ?? old('uniform_issue_date') }}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" name="sandal_issue_date" class="form-control"
                                    value="{{ $draftData['sandal_issue_date'] ?? old('sandal_issue_date') }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="address" class="form-control"
                                    value="{{ $draftData['address'] ?? old('address') }}">
