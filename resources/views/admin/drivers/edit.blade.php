            ...
            <form method="POST" action="{{ route('admin.drivers.update', $driver->id) }}" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="serial_no" class="form-control" value="{{$driver->serial_no}}" readonly>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="full_name" class="form-control" value="{{ old('full_name', $driver->full_name ?? '') }}">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="father_name" class="form-control" value="{{ old('father_name', $driver->father_name ?? '') }}">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="mother_name" class="form-control" value="{{ old('mother_name', $driver->mother_name ?? '') }}">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="number" min="0" step="1" name="salary" class="form-control" value="{{ old('salary', $driver->salary ?? '') }}">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="account_no" class="form-control" value="{{ old('account_no', $driver->account_no ?? '') }}">
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="driver_status_id">
                      ...
                      @foreach($driver_status as $key => $value)
                        <option value="{{$key}}" {{ old('driver_status_id', $driver->driver_status_id ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
              ...
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="marital_status_id">
                      ...
                      @foreach($marital_status as $key => $value)
                        <option value="{{$key}}" {{ old('marital_status_id', $driver->marital_status_id ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <strong>DOB</strong>
                    <input type="date" name="dob" class="form-control" value="{{ old('dob', $driver->dob ?? '') }}">
                    @if ($errors->has('dob'))
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select select2 vehicle" id="vehicle_id" name="vehicle_id">
                      ...
                      @foreach($vehicles as $key => $value)
                        <option value="{{$key}}" {{ old('vehicle_id', $driver->vehicle_id ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="eobi_no" class="form-control" value="{{ old('eobi_no', $driver->eobi_no ?? '') }}">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="date" name="eobi_start_date" class="form-control" value="{{ old('eobi_start_date', $driver->eobi_start_date ?? '') }}">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="date" name="employment_date" class="form-control" value="{{ old('employment_date', $driver->employment_date ?? '') }}">
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="license_category_id">
                      ...
                      @foreach($licence_category as $key => $value)
                        <option value="{{$key}}" {{ old('license_category_id', $driver->license_category_id ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="date" name="uniform_issue_date" class="form-control" value="{{ old('uniform_issue_date', $driver->uniform_issue_date ?? '') }}">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="date" name="sandal_issue_date" class="form-control" value="{{ old('sandal_issue_date', $driver->sandal_issue_date ?? '') }}">
