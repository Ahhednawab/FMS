...
@section('content')
    ...
    <div class="content">
        ...
        <div class="card">
                        ...
                        <div class="row kilometer">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" step="1" class="form-control previous_km" name="previous_km[]"
            ...
            @if($draftData && !isset($draftData->data['current_kms'][$key]))
                is-invalid
            @endif"
                                           name="current_km[{{ $key }}]"
...
{{--                                    <input type="number" min="0" step="1" class="form-control" name="mileage[]" value="{{ old('mileage.' . $key) }}" readonly>--}}
                                    ...
                                    <input type="number" min="0" step="1" class="form-control" name="mileage[]"
                                           value="{{ old('mileages.' . $key, isset($draftData->data['mileages'][$key]) ? $draftData->data['mileages'][$key] : '') }}" readonly>
