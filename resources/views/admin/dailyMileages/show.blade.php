        ...
        <div class="page-header-content header-elements-lg-inline">
            ...
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <a href="{{ route('dailyMileages.index') }}" class="btn btn-primary"><span>View Daily Mileage <i
                ...
                <div class="container mt-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="text-right">
                            <a href="{{ route('dailyMileages.edit', $dailyMileage->id) }}" class="btn btn-warning">Edit</a>
                            <a href="{{ route('dailyMileages.index') }}" class="btn btn-secondary">Back</a>
                            <form action="{{ route('dailyMileages.destroy', $dailyMileage->id) }}" method="POST"
                                style="display:inline-block;"
                                onsubmit="return confirm('Are you sure you want to delete this Daily Mileage?');">
                                @csrf
                                @method('DELETE')
