    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('dailyFuels.update', $dailyFuel->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="vehicle_no"
                                            value="{{ old('vehicle_id', $dailyFuel->vehicle->vehicle_no ?? '') }}" readonly>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="report_date"
                                            value="{{ old('report_date', $dailyFuel->report_date ?? '') }}">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" step="1" class="form-control"
                                            name="previous_km"
                                            value="{{ old('previous_km', $dailyFuel->previous_km ?? '') }}" readonly>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" step="1" class="form-control"
                                            name="current_km" value="{{ old('current_km', $dailyFuel->current_km ?? '') }}">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" step="1" class="form-control"
                                            name="mileage" value="{{ old('mileage', $dailyFuel->mileage ?? '') }}" readonly>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" step="0.01" class="form-control"
                                            name="fuel_taken"
                                            value="{{ old('fuel_taken', $dailyFuel->fuel_taken ?? '') }}">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" step="0.1" class="form-control"
                                            name="fuel_average"
                                            value="{{ old('fuel_average', $dailyFuel->fuel_average ?? '') }}" readonly>
