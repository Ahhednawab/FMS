  ...
  <div class="content">
    ...
    <div class="card">
      <div class="card-body">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" id="column-visibility">
                        ...
                        <div class="px-3">
                            ...
                            <div class="custom-control custom-checkbox mb-2">
                                ...
                                <label class="custom-control-label" for="col4">Previous KM</label>
                            </div>
                            <div class="custom-control custom-checkbox mb-2">
                                <input type="checkbox" class="custom-control-input column-toggle" id="col5" data-column="4" checked>
                                <label class="custom-control-label" for="col5">Current KM</label>
                            </div>
                            <div class="custom-control custom-checkbox mb-2">
                            ...
                            <div class="custom-control custom-checkbox mb-2">
                                ...
                                <label class="custom-control-label" for="col7">Fuel Taken</label>
                            </div>
                            <div class="custom-control custom-checkbox mb-2">
                                <input type="checkbox" class="custom-control-input column-toggle" id="col8" data-column="7" checked>
                                <label class="custom-control-label" for="col8">Fuel Avg.</label>
                            </div>
                            <div class="custom-control custom-checkbox mb-2">
                                <input type="checkbox" class="custom-control-input column-toggle" id="col9" data-column="8" checked>
                                <label class="custom-control-label" for="col9">AKPL</label>
                            </div>
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input column-toggle" id="col10" data-column="9" checked>
                                <label class="custom-control-label" for="col10">Actions</label>
                            </div>
                        </div>
                    </div>
        ...
        <table id="dailyFuels" class="table datatable-colvis-basic dataTable">
          <thead>
            <tr>
              <th>Vehicle</th>
              <th>Station</th>
    ...
    $(document).ready(function () {
        ...
        var table = $('.datatable-colvis-basic').DataTable({
            ...
            columns: [
                ...
                { visible: true }, // Previous KM
                { visible: true }, // Current KM
                { visible: true }, // Mileage
                { visible: true }, // Fuel Taken
                { visible: true }, // Fuel Avg.
                { visible: true }, // AKPL
