                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input value="{{ $serial_no }}" name="serial_no" value="{{ old('serial_no') }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="product_category_id">
                                    ...
                                    @foreach ($productCategory as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('product_category_id') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="brand_id">
                                    ...
                                    @foreach ($brands as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('brand_id') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="unit_id">
                                    ...
                                    @foreach ($units as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('unit_id') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
