                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $productList->serial_no }}" name="serial_no" type="text"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name"
                                            value="{{ old('name', $productList->name ?? '') }}">
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="product_category_id">
                                            ...
                                            @foreach ($productCategory as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ old('product_category_id', $productList->product_category_id ?? '') == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="brand_id">
                                            ...
                                            @foreach ($brands as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ old('brand_id', $productList->brand_id ?? '') == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="unit_id">
                                            ...
                                            @foreach ($units as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ old('unit_id', $productList->unit_id ?? '') == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
