  ...
  <div class="page-header page-header-light">
    <div class="page-header-content header-elements-lg-inline">
      <div class="page-title d-flex">
        <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Insurance Company Detail</span></h4>
        ...
        <div class="row mt-3">
          <div class="col-md-12">
            <div class="text-right">
              <a href="{{ route('admin.insurance-companies.edit', $insurance_company->id) }}" class="btn btn-warning">
              ...
              <form action="{{ route('admin.insurance-companies.destroy', $insurance_company->id) }}" 
                    method="POST" 
