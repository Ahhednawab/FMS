    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Insurance Companies List</span>
                </h4>
                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="{{ route('insurance-companies.show', $company->id) }}"
                                                    class="dropdown-item">
                                                ...
                                                <form action="{{ route('insurance-companies.destroy', $company->id) }}"
