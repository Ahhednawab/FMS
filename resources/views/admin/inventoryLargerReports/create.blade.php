...
@section('title', 'Add Inventory Larger Report')

@section('content')
  <div class="page-header page-header-light">
    <div class="page-header-content header-elements-lg-inline">
      <div class="page-title d-flex">
          <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Inventory Larger Report Management</span></h4>
      </div>
  ...
  <div class="content">
    <div class="card">
      <div class="card-body">
        <form action="{{ route('admin.inventoryLargerReports.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input value="{{$report_id}}" name="report_id" type="text" class="form-control" readonly>
              </div>
            </div>
              ...
              <div class="form-group">
                ...
                <select class="custom-select" name="supplier">
                  ...
                  @foreach($suppliers as $key => $value)
                    <option value="{{$key}}" {{ old('supplier') == $key ? 'selected' : '' }}>{{$value}}</option>
                  @endforeach
                </select>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="number" min="1" step="1" class="form-control" name="order_quantity" value="{{ old('order_quantity') }}">
