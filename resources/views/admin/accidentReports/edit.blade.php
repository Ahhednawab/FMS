    ...
    <div class="page-header-content header-elements-lg-inline">
      ...
      <div class="header-elements d-none">
        <div class="d-flex justify-content-center">
          <a href="{{ route('admin.accidentReports.index') }}" class="btn btn-primary">
  ...
  <div class="content">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <form method="POST" action="{{ route('admin.accidentReports.update', $accidentReport->id) }}" enctype="multipart/form-data">
              @csrf
              @method('PUT')
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input value="{{$accidentReport->accident_report_id}}" name="accident_report_id" type="text" class="form-control" readonly>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="accident_type">
                      ...
                      @foreach($accident_types as $key => $value)
                        <option value="{{$key}}" {{ old('accident_type', $accidentReport->accident_type ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="location" value="{{ old('location', $accidentReport->location ?? '') }}">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="accident_date" value="{{ old('accident_date', $accidentReport->accident_date ?? '') }}">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">                
                    ...
                    <input type="time" class="form-control" name="accident_time" value="{{ old('accident_time', $accidentReport->accident_time ?? '') }}">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="accident_description" value="{{ old('accident_description', $accidentReport->accident_description ?? '') }}">
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="person_involved">
                      ...
                      @foreach($users as $key => $value)
                        <option value="{{$key}}" {{ old('person_involved', $accidentReport->person_involved ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="injury_type">
                      ...
                      @foreach($injury_types as $key => $value)
                        <option value="{{$key}}" {{ old('injury_type', $accidentReport->injury_type ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
              ...
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="damage_type">
                      ...
                      @foreach($damage_types as $key => $value)
                        <option value="{{$key}}" {{ old('damage_type', $accidentReport->damage_type ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="witness_involved">
                      ...
                      @foreach($status as $key => $value)
                        <option value="{{$key}}" {{ old('witness_involved', $accidentReport->witness_involved ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="vehicle_no" value="{{ old('vehicle_no', $accidentReport->vehicle_no ?? '') }}">
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="primary_cause">
                      ...
                      @foreach($primary_cause as $key => $value)
                        <option value="{{$key}}" {{ old('primary_cause', $accidentReport->primary_cause ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="medical_provided">
                      <option value="">--Select--</option>
                      @foreach($status as $key => $value)
                        <option value="{{$key}}" {{ old('medical_provided', $accidentReport->medical_provided ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="police_report_filed">
                      <option value="">--Select--</option>
                      @foreach($status as $key => $value)
                        <option value="{{$key}}" {{ old('police_report_filed', $accidentReport->police_report_filed ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="investigation_status">
                      ...
                      @foreach($investigation_status as $key => $value)
                        <option value="{{$key}}" {{ old('investigation_status', $accidentReport->investigation_status ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
                    @if ($errors->has('investigation_status'))
                      <label class="text-danger">{{ $errors->first('investigation_status') }}</label>
                    @endif
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="insurance_claimed">
                      <option value="">--Select--</option>
                      @foreach($status as $key => $value)
                        <option value="{{$key}}" {{ old('insurance_claimed', $accidentReport->insurance_claimed ?? '') == $key ? 'selected' : '' }}>{{$value}}</option>
                      @endforeach
                    </select>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="text-right">
                    ...
                    <a href="{{ route('admin.accidentReports.index') }}" class="btn btn-warning">Cancel</a>
                  </div>
                </div>
              </div>     
            </form>
