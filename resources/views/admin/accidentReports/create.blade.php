...
@section('content')
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Accident Reports
                        Management</span></h4>
            </div>
    ...
    <div class="content">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('accidentReports.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input value="{{ $accident_report_id }}" name="accident_report_id" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="accident_type">
                                    ...
                                    @foreach ($accident_types as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('accident_type') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="accident_description"
                                    value="{{ old('accident_description') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="person_involved">
                                    ...
                                    @foreach ($users as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('person_involved') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="injury_type">
                                    ...
                                    @foreach ($injury_types as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('injury_type') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="damage_type">
                                    ...
                                    @foreach ($damage_types as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('damage_type') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="witness_involved">
                                    ...
                                    @foreach ($status as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('witness_involved') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="primary_cause">
                                    ...
                                    @foreach ($primary_cause as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('primary_cause') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="medical_provided">
                                    ...
                                    @foreach ($status as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('medical_provided') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="police_report_filed">
                                    ...
                                    @foreach ($status as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('police_report_filed') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="investigation_status">
                                    ...
                                    @foreach ($investigation_status as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('investigation_status') == $key ? 'selected' : '' }}>
                                            {{ $value }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="insurance_claimed">
                                    ...
                                    @foreach ($status as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('insurance_claimed') == $key ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                    @endforeach
                                </select>
