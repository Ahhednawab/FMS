  ...
  <div class="page-header page-header-light">
    <div class="page-header-content header-elements-lg-inline">
      <div class="page-title d-flex">
        <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Accident Report Detail</span></h4>
        <a href="#" class="header-elements-toggle text-body d-lg-none"><i class="icon-more"></i></a>
      </div>
      <div class="header-elements d-none">
        <div class="d-flex justify-content-center">
          <a href="{{ route('admin.accidentReports.index') }}" class="btn btn-primary"><span>View Accident Report <i class="icon-list ml-2"></i></span></a>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="col-md-3 text-center">
              <div class="card">
                ...
                @if($accidentReport->insurance_doc)
                  <a href="{{ asset('uploads/accidentReports/' . $accidentReport->insurance_doc) }}" download>Download</a>
                @else
                  <p>N/A</p>
                @endif
              </div>
            ...
            <div class="col-md-3 text-center">
              <div class="card">
                ...
                @if($accidentReport->police_report_file)
                  <a href="{{ asset('uploads/accidentReports/' . $accidentReport->police_report_file) }}" download>Download</a>
                @else
                  <p>N/A</p>
                @endif
              </div>
          ...
          <div class="col-md-12">
            ...
            <div class="text-right">
              <a href="#" class="btn btn-warning">Edit</a>
                <a href="{{ route('admin.accidentReports.index') }}" class="btn btn-secondary">Back</a>
                <form action="{{ route('admin.accidentReports.destroy', $accidentReport->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this Accident Report?');">
                  @csrf
                  @method('DELETE')
