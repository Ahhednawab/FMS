                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="{{ route('brands.show', $value->id) }}" class="dropdown-item"><i
                                                        class="icon-eye"></i> View</a>
                                                <a href="{{ route('brands.edit', $value->id) }}" class="dropdown-item"><i
                                                        class="icon-pencil7"></i> Edit</a>
                                                <form method="POST" action="{{ route('brands.destroy', $value->id) }}"
