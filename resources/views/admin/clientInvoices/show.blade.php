    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Client Invoice Detail</span>
                </h4>
                <a href="#" class="header-elements-toggle text-body d-lg-none"><i class="icon-more"></i></a>
            </div>
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <a href="{{ route('clientInvoices.index') }}" class="btn btn-primary"><span>View Client Invoice <i
                ...
                <div class="container mt-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="text-right">
                            ...
                            <a href="{{ route('clientInvoices.index') }}" class="btn btn-secondary">Back</a>
                            <form action="{{ route('clientInvoices.destroy', 1) }}" method="POST"
                                style="display:inline-block;"
                                onsubmit="return confirm('Are you sure you want to delete this Client Invoice?');">
                                @csrf
                                @method('DELETE')
