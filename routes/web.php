...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('trackingData/monthly/dates', [TrackingController::class, 'monthlyDates'])->name('trackingData.monthly.dates');
    Route::post('trackingData/monthly/sync-date', [TrackingController::class, 'syncMonthlyDate'])->name('trackingData.monthly.syncDate');
...
Route::get('daily-fuels/fetch-previous-km-by-date', [DailyFuelController::class, 'fetchPreviousKmByDate'])
    ...
    // Vehicle Maintenance
    Route::get('vehicleMaintenances/vehicle/{vehicle}/details', [VehicleMaintenanceController::class, 'vehicleDetails'])
